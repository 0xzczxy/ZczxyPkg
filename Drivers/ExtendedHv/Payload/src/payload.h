...
typedef struct __attribute__((align(16))) GUEST_CONTEXT {
  uint8_t Reserved1[8];
  uint64_t Rcx;
  uint64_t Rdx;
  uint64_t Rbx;
...
typedef struct _VMCB_CONTROL_AREA {
  ...
  uint8_t  Reserved5[0x0cb - 0x0a0];    // +0x0a0
  uint8_t  Cpl;                         // +0x0cb
  uint32_t Reserved6;                   // +0x0cc
  uint64_t Efer;                        // +0x0d0
  uint8_t  Reserved7[0x148 - 0x0d8];    // +0x0d8
  uint64_t Cr4;                         // +0x148
  uint64_t Cr3;                         // +0x150
  uint64_t Cr0;                         // +0x158
  uint64_t Dr7;                         // +0x160
  ...
  uint64_t Rip;                         // +0x178
  uint8_t  Reserved8[0x1d8 - 0x180];    // +0x180
  uint64_t Rsp;                         // +0x1d8
  uint8_t  Reserved9[0x1f8 - 0x1e0];    // +0x1e0
  uint64_t Rax;                         // +0x1f8
  uint64_t Star;                        // +0x200
  ...
  uint64_t Cr2;                         // +0x240
  uint8_t  Reserved10[0x268 - 0x248];   // +0x248
  uint64_t GPat;                        // +0x268
